...
SAVE_DIR=../models/small_task2/615m_parallel_data

lang_pairs=language_pairs_for_smallTask2.txt
...
python $TOOL \
    ...
    --save-interval 1 --save-interval-updates 5000 --keep-interval-updates 20 --keep-last-epochs 10 \
    --max-epoch 20 \
    --seed 222 \
